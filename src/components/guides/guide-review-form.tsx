...
import { submitGuideReviewAction } from "@/server/actions/guide-reviews";

/// Radio buttons under the stars, so the rating works without JavaScript and
...
export function GuideReviewForm({
  ...
  return (
    <form action={formAction} className="card space-y-4 sm:p-6">
      ...
      <div>
        <span className="label">{guides("rateThisGuide")}</span>
            ...
            return (
              ...
              >
                ...
                <svg
                  ...
                  className={`h-7 w-7 transition ${value <= shown ? "" : "opacity-35"}`}
                >
      ...
      <label className="block">
        ...
        <textarea
          ...
          placeholder={guides("reviewPlaceholder")}
        />
      </label>
